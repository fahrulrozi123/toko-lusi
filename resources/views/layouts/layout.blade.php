...
<head>
  ...
  <title>Lusi Shop - @yield('title')</title>
                          ...
                          <form method="POST" action="{{ route('logout') }}">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item">
                                  ...
                                  <a class="nav-link" href="{{ route('costumer.logout') }}" onclick="event.preventDefault();
	...
	<footer class="footer">
				...
				<div class="row section_gap">
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget tp_widgets">
							...
							<p>
								Memperkenalkan produk asli Indonesi kepada masyarakat lokal khuususnya Tangerang, dengan kualitas terbaik.
							</p>
							<p>
                  ...
                  <div class="slider-container">
                      <div class="slick-slider">
                          @foreach ($products as $row)
                              <div><img src="{{ asset('products/' . $row->image) }}" class="img-fluid" style="height: 70px;" alt="{{ $row->name }}"></div>
                          @endforeach
                      </div>
                  </div>
              </div>
		...
		<div class="footer-bottom">
			<div class="container">
              ...
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Toko Lusi</a>
          </p>
				</div>
			</div>
		</div>
